...
import recomendations_pb2_grpc
...
class RecommendationService(recomendations_pb2_grpc.RecommendationsServicer):
...
def serve():
    ...
    recomendations_pb2_grpc.add_RecommendationsServicer_to_server(
