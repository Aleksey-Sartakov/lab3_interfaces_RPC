...
class RecommendationsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recommend = channel.unary_unary(
                ...
                request_serializer=recomendations__pb2.RecommendationRequest.SerializeToString,
...
def add_RecommendationsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Recommend': grpc.unary_unary_rpc_method_handler(
                    servicer.Recommend,
                    request_deserializer=recomendations__pb2.RecommendationRequest.FromString,
...
class Recommendations(object):
    ...
    def Recommend(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Recommendations/Recommend',
            recomendations__pb2.RecommendationRequest.SerializeToString,
